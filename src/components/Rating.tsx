...
export function Rating() {
    ...
    return isSubmitted ? ( <div className={styles.thankYouPanel}><img src="/illustration-thank-you.svg" />

        <p className={styles.selected}>You selected {selectedRating} out of 5</p>
    
        <h1 className={styles.title}>Thank You!</h1>

        <p className={styles.description}>We appreciate you taking the time to give a rating. If you ever need more support, don’t hesitate to get in touch!</p></div> ): 
        (
        ...
        <div className={styles.group}>
         ...
         <button type='button' onClick={() => handleRatingClicked(rating)} className={styles.rating}>{rating}</button>
            ))}
        </div>
